    ...
    <div class="container">
        <div class="d-flex justify-content-between">
            ...
            <nav class="breadcrumb mb-0">
                ...
                <a class="breadcrumb-item small text-body" href="../login-signup/signup.php"><i class="fas fa-user"></i></a>
           </nav>
        </div>
    </div>
</div>
<!-- Topbar End -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="ms-auto d-none d-lg-flex">
                        <a class="btn btn-sm-square btn-primary ms-2" href="../login-signup/signup.php"><i class="fas fa-user"></i></a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">"At Lab Automation, our experts provide tailored solutions to elevate your laboratory’s performance. Leverage cutting-edge technologies for seamless and efficient automation."</p>
                    <div class="row g-4 g-sm-5 justify-content-center">
                        ...
                        <div class="col-sm-6 text-start">
                            <div class="about-fact btn-square flex-column rounded-circle bg-secondary me-sm-auto">
                                ...
                                <h1 class="text-white mb-0" data-toggle="counter-up">550</h1>
                            </div>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="row g-0">
                <div class="col-lg-6 pt-lg-5">
                    <div class="bg-white p-5 mt-lg-5">
                        <h1 class="display-6 mb-4 wow fadeIn" data-wow-delay="0.3s">The Best Lab Automation Solution</h1>
                        <p class="mb-4 wow fadeIn" data-wow-delay="0.4s">"Lab Automation delivers cutting-edge solutions that streamline testing, increase accuracy, and optimize efficiency in laboratory workflows."</p>
                        <div class="row g-5 pt-2 mb-5">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="icon-box-primary mb-4">
                                    <i class="bi bi-person-plus text-dark"></i>
                                </div>
                                <h5 class="mb-3">Automation Experts</h5>
                                <span>"Automation experts at Lab Automation ensure seamless integration and precision in every lab solution, driving efficiency and innovation."</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <span>"Advanced testing solutions provide precise diagnostics, enhancing lab efficiency and accuracy."</span>
                            </div>
                        </div>
                        ...
                        <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                            <div class="d-flex align-items-center justify-content-center" style="min-height: 300px;">
                                <button type="button" class="btn-play" data-bs-toggle="modal"
                                    data-src="https://youtu.be/HkL6PPDfW0w?si=6mtAIKSn0nIZJORY" data-bs-target="#videoModal">
                                    <span></span>
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="ratio ratio-16x9">
                       <iframe class="embed-responsive-item" width="560" height="315" src="https://www.youtube.com/embed/HkL6PPDfW0w?si=6mtAIKSn0nIZJORY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="container-fluid container-team py-5">
    <div class="container pb-5">
        <h1 class="display-6 text-center text-black mb-4">Our Team!</h1>
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    ...
                    <div class="text-center p-4">
                        <h5 class="mb-1">Syed Salik Ali</h5>
        ...
        <div class="container">
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <p class="fs-5 mb-4">"Lab Automation brings you intelligent solutions to optimize your workflow. Discover how automation can enhance productivity and drive results."

...
$allCategoriesResult = $connection->query("SELECT * FROM category");

// Get selected category name from URL
$category_name = isset($_GET['category_name']) ? $_GET['category_name'] : '';

// SQL query for displaying the filtered categories based on selection
...
<div class="container-fluid container-service py-5">
    <div class="container pt-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <p class="mb-5">"Lab Automation offers reliable, high-quality laboratory services that prioritize accuracy and efficiency. Our commitment to excellence ensures every test meets the highest standards."</p>
        </div>
        ...
        <div class="dropdown mb-5 text-center">
            ...
            <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
                ...
                <li>
                    <a class="dropdown-item <?php echo $category_name == '' ? 'active' : ''; ?>" href="category.php">All Categories</a>
                </li>

                <!-- Loop through all categories for dropdown items -->
                <?php if ($allCategoriesResult->num_rows > 0) : ?>
                    <?php while ($row = $allCategoriesResult->fetch_assoc()) : ?>
                        <li>
                            <a class="dropdown-item <?php echo $category_name == $row['category_name'] ? 'active' : ''; ?>" href="category.php?category_name=<?php echo urlencode($row['category_name']); ?>">
        ...
        <div class="row g-4">
            <?php 
            // Reset pointer for $result in case it’s being reused below
            $result->data_seek(0); 
            while ($row = $result->fetch_assoc()) : ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        <div class="icon-box-primary mb-4">
                            <img src="<?php echo $row['category_img']; ?>" alt="Category Image" width="190px" height="240px" style="border: 4px solid #3368c6; border-radius: 5px;">
                        </div>
                        <h4 class="mb-3" style="text-transform: capitalize;">Category Name: <?php echo $row['category_name']; ?></h4>
                        <a class="btn btn-light px-3" href="../products/product.php?category_name=<?php echo urlencode($row['category_name']); ?>">View Products<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
            <?php endwhile; ?>
        </div> 
            ...
            <div class="col-lg-6 ps-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a class="btn btn-link" href="./category.php">Categories</a>
                        <a class="btn btn-link" href="../aboutus/about.php">About Us</a>
                        <a class="btn btn-link" href="../contactus/contact.php">Contact Us</a>
                        <a class="btn btn-link" href="../test/testing.php">Testing</a>
                    </div>

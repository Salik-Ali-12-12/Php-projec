                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="#">User Testing Products</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Testing Requests Lists</h1>
                    ...
                    <div class="card mb-4 card mb-4 shadow">
                        <div class="card-body">
                            ...
                            <p>List of all active testing Requests and their details.</p>
                        </div>
                    </div>
                    <div class="card mb-4">
...
?>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row['rand_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['testing_status']) . "</td>";
                        echo "</tr>";
                    }
                    ?>
                                </tbody>
